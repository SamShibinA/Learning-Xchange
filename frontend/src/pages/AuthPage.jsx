...
// // // //       onLogin(data); // Send user object to parent
// // // //     } catch (err) {
// // // //       console.error(err);
...
// // // import {
// // //   Box, Button, TextField, Typography, Paper, IconButton, Avatar,
...
// // //   return (
// // //     <Box sx={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', bgcolor: '#ffffff', px: 2 }}>
// // //       <Box sx={{ width: '100%', maxWidth: 400 }}>
// // //         <Box textAlign="center" mb={4}>
// // //           <Avatar sx={{ bgcolor: 'primary.main', width: 64, height: 64, mx: 'auto', mb: 2 }}>
// // //             <BookOpen size={32} color="#fff" />
// // //           </Avatar>
// // //           <Typography variant="h4" fontWeight="bold">LearningXchange</Typography>
// // //           <Typography variant="body2" color="text.secondary">Connect, Learn, and Grow Together</Typography>
// // //         </Box>

// // //         <Paper elevation={3} sx={{ borderRadius: 4, p: 4 }}>
// // //           <Box display="flex" gap={1} mb={3}>
// // //             <Button variant={isLogin ? 'contained' : 'text'} onClick={() => setIsLogin(true)} fullWidth>Sign In</Button>
// // //             <Button variant={!isLogin ? 'contained' : 'text'} onClick={() => setIsLogin(false)} fullWidth>Sign Up</Button>
// // //           </Box>
...
// // //                 <Box mb={2}>
// // //                   <Typography variant="subtitle2" mb={1}>I want to join as a</Typography>
// // //                   <ToggleButtonGroup value={role} exclusive onChange={(e, val) => val && setRole(val)} fullWidth>
...
// // //             <TextField label="Email Address" type="email" value={email} onChange={(e) => setEmail(e.target.value)} fullWidth margin="normal" required />
// // //             <TextField
// // //               label="Password"
// // //               type={showPassword ? 'text' : 'password'}
// // //               value={password}
...
// //       onLogin(user);  // App decides if ProfileSetup or Dashboard
// //     } catch (err) {
...
// //       alignItems: 'center', bgcolor: '#ffffff', px: 2,
// //     }}>
// //       <Box sx={{ width: '100%', maxWidth: 400 }}>
// //         <Box textAlign="center" mb={4}>
// //           <Avatar sx={{ bgcolor: 'primary.main', width: 64, height: 64, mx: 'auto', mb: 2 }}>
...
// //                     onChange={(e, newRole) => newRole && setRole(newRole)} fullWidth
// //                   >
// //                     <ToggleButton value="learner" sx={{ flex: 1 }}>
// //                       <Box display="flex" flexDirection="column" alignItems="center">
// //                         <BookOpen size={20} /> Learner
// //                       </Box>
// //                     </ToggleButton>
// //                     <ToggleButton value="tutor" sx={{ flex: 1 }}>
// //                       <Box display="flex" flexDirection="column" alignItems="center">
// //                         <GraduationCap size={20} /> Tutor
// //                       </Box>
// //                     </ToggleButton>
// //                   </ToggleButtonGroup>
// //                 </Box>
...
// Replace localStorage usage with API
import React, { useState } from 'react';
import {
  Box, Button, TextField, Typography, Paper, IconButton, Avatar,
  ToggleButton, ToggleButtonGroup, Alert, CircularProgress
...
const AuthPage = ({ onLogin }) => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', bgcolor: '#fff', px: 2 }}>
      <Box sx={{ width: '100%', maxWidth: 400 }}>
        <Box textAlign="center" mb={4}>
          <Avatar sx={{ bgcolor: 'primary.main', width: 64, height: 64, mx: 'auto', mb: 2 }}>
            <BookOpen size={32} color="#fff" />
          ...
          <form onSubmit={handleSubmit}>
            {!isLogin && (
              <>
                ...
                <Box mb={2}>
                  <Typography variant="subtitle2" mb={1}>I want to join as a</Typography>
                  <ToggleButtonGroup value={role} exclusive onChange={(e, newRole) => newRole && setRole(newRole)} fullWidth>
                    <ToggleButton value="learner"><Box display="flex" flexDirection="column" alignItems="center"><BookOpen size={20} />Learner</Box></ToggleButton>
                    <ToggleButton value="tutor"><Box display="flex" flexDirection="column" alignItems="center"><GraduationCap size={20} />Tutor</Box></ToggleButton>
                  </ToggleButtonGroup>
                </Box>
              </>
            )}
